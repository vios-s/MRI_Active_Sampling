...
class FastMriDataModule(pl.LightningDataModule):
    ...
    def _create_data_loader(self, 
        ...
        #     print(f"Batch {batch_idx + 1}:", batch.label)

        print("\n")
        print(f'{data_partition}:{self.batch_size * len(dataloader)}')
        return dataloader
    ...
    def add_data_specific_args(parent_parser):
        ...
        parser.add_argument("--sample_rate", type=float, default=0.8, help="Fraction of slices to use for training")
        parser.add_argument("--val_sample_rate", type=float, default=0.8, help="Fraction of slices to use for validation")
        parser.add_argument("--test_sample_rate", type=float, default=0.8, help="Fraction of slices to use for testing")
        ...
        parser.add_argument("--use_dataset_cache", type=bool, default=False, help="Whether to cache dataset metadata in memory")
