...
class FastMriDataModule(pl.LightningDataModule):
    ...
    def add_data_specific_args(parent_parser):
        ...
        parser.add_argument("--sample_rate", type=float, default=1, help="Fraction of slices to use for training")
        parser.add_argument("--val_sample_rate", type=float, default=1, help="Fraction of slices to use for validation")
        parser.add_argument("--test_sample_rate", type=float, default=1, help="Fraction of slices to use for testing")
